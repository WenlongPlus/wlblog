...
<@header title="${config.siteName!} | 个人博客"
...
<div class="container custome-container">
            ...
            <div class="scrolltext">
                <ul class="list-unstyled" id="notice-box">
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">本站正式启用域名:<a href="https:/www.wlblog.online" target="_blank"><strong>https:/www.wlblog.online</strong></a></a>
                    </li>
                   <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">博学之 审问之 慎思之 明辨之 笃行之</a>
                    </li>
                    <li class="scrolltext-title">
                        <a href="javascript:void(0)" rel="bookmark">工欲善其事 必先利其器</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-8 blog-main">
            <@articleTag method="recommendedList" pageSize="6">
                    ...
                    <article class="fade-in">
                        <#if item.coverImage?? && (item.coverImage?length > 7)>
                            <figure class="thumbnail">
                                ...
                                <div class="zyd-carousel-caption">${item.type.name}</div>
                            </figure>
                        </#if>
                        <header class="entry-header">
                            ...
                            <#--<span><a style="font-weight: bold; color:#009A61" href="${config.siteUrl}/type/${item.typeId?c}">${item.type.name}</a></span>-->
