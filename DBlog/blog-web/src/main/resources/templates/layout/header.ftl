        ...
        <div class="pull-left">
            <ul class="list-unstyled list-inline">
                <#--<li><span id="currentTime"></span></li>-->
                    ...
                    <li><a href="${config.siteUrl}/links" class="menu_a handshake-o" title="友情链接" data-toggle="tooltip" data-placement="bottom">友情链接</a></li>
            </ul>
            <div class="clear"></div>
        </div>
        <div class="menu-topmenu-container pull-right">
            <ul class="list-unstyled list-inline pull-left">
             ...
             -->   <li><a href="/guestbook" class="menu_a"><i class="fa fa-comments-o"></i>留言板</a></li>
                   <li><a href="/timeline" class="menu_a"><i class="fa fa-calendar"></i>时光轴</a></li>
            </ul>
            <#if user??>
                ...
                <div class="oauth">
                    ...
                    <div class="oauth-line">
                        <span style="font-size: 12px">
                            Powered by <a href="http://www.wlblog.online" target="_blank">wlblog</a>
                        </span>
                    </div>
                </div>
            </div>
