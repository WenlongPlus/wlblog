...
<div class="modal fade" id="reward" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">拿钱去买猫粮，楼下的流浪猫在等我('')ﾉ</h4>
            </div>
            <div class="modal-body">
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12 col-md-12 col-lg-12">
                        ...
                        <p><#if config.copyright!>${config.copyright} |</#if> Powered by <a href="https://gitee.com/yadong.zhang/DBlog" title="人间有味是清欢" data-toggle="tooltip" data-placement="right" target="_blank"><i>wlblog.online</i></a>  </p>
                        <#if url?? && (url == "index")>
